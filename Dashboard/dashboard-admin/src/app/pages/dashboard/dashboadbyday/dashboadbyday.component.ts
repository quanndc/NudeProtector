...
@Component({
  selector: 'app-dashboadbyday',
  templateUrl: './dashboadbyday.component.html',
  styleUrl: './dashboadbyday.component.scss',
})
export class DashboadbydayComponent implements OnInit {
  chart: ChartOptions = {
    animations: {
      enabled: true,
      easing: 'easeinout',
